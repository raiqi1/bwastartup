...
func (s *service) CreateCampaign(input CreateCampaignInput) (Campaign, error) {
	...
	newCampaing, err := s.repository.Save(campaign)
	if err != nil {
		return newCampaing, err
	}
	return newCampaing, nil
...
func (s *service) DeleteCampaign(inputID GetCampaignDetailInput, deleteData CreateCampaignInput) (Campaign, error) {
	...
	return deletedCampaign, nil
}

func (s *service) SaveCampaignImage(input CreateCampaignImageInput, fileLocation string) (CampaignImage, error) {

	camapign, err := s.repository.FindByID(input.CampaignID)
	if err != nil {
		return CampaignImage{}, err
	}

	if camapign.UserID != input.User.ID {
